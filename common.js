...
/**
 * Given a pi/16 rotation, returns a String that expresses
 * it in radians
 *
 * @param piOver16Arg int in range 0-31 inclusive
 * @returns String that expresses radians
 */
function piOver16RadiansStr(piOver16Arg) {
  radStr = '0';
  if (piOver16Arg == 1) {
    radStr = 'pi/16';
  }
  else if (piOver16Arg == 2) {
    radStr = 'pi/8';
  }
  else if (piOver16Arg == 3) {
    radStr = '3*pi/16';
  }
  else if (piOver16Arg == 4) {
    radStr = 'pi/4';
  }
  else if (piOver16Arg == 5) {
    radStr = '5*pi/16';
  }
  else if (piOver16Arg == 6) {
    radStr = '3*pi/8';
  }
  else if (piOver16Arg == 7) {
    radStr = '7*pi/16';
  }
  else if (piOver16Arg == 8) {
    radStr = 'pi/2';
  }
  else if (piOver16Arg == 9) {
    radStr = '9*pi/16';
  }
  else if (piOver16Arg == 10) {
    radStr = '5*pi/8';
  }
  else if (piOver16Arg == 11) {
    radStr = '11*pi/16';
  }
  else if (piOver16Arg == 12) {
    radStr = '3*pi/4';
  }
  else if (piOver16Arg == 13) {
    radStr = '13*pi/16';
  }
  else if (piOver16Arg == 14) {
    radStr = '7*pi/8';
  }
  else if (piOver16Arg == 15) {
    radStr = '15*pi/16';
  }
  else if (piOver16Arg == 16) {
    radStr = 'pi';
  }
  else if (piOver16Arg == 17) {
    radStr = '17*pi/16';
  }
  else if (piOver16Arg == 18) {
    radStr = '9*pi/8';
  }
  else if (piOver16Arg == 19) {
    radStr = '19*pi/16';
  }
  else if (piOver16Arg == 20) {
    radStr = '5*pi/4';
  }
  else if (piOver16Arg == 21) {
    radStr = '21*pi/16';
  }
  else if (piOver16Arg == 22) {
    radStr = '11*pi/8';
  }
  else if (piOver16Arg == 23) {
    radStr = '23*pi/16';
  }
  else if (piOver16Arg == 24) {
    radStr = '3*pi/2';
  }
  else if (piOver16Arg == 25) {
    radStr = '25*pi/16';
  }
  else if (piOver16Arg == 26) {
    radStr = '13*pi/8';
  }
  else if (piOver16Arg == 27) {
    radStr = '27*pi/16';
  }
  else if (piOver16Arg == 28) {
    radStr = '7*pi/4';
  }
  else if (piOver16Arg == 29) {
    radStr = '29*pi/16';
  }
  else if (piOver16Arg == 30) {
    radStr = '15*pi/8';
  }
  else if (piOver16Arg == 31) {
    radStr = '31*pi/16';
  }
  return radStr;
}
